    ...
    return (
        <aside className={props.expand ? 'app-sidebar expanded' : 'app-sidebar'}>
            ...
            <div className="sidebar-actions">
                <button type="button" onClick={() => {}} className={'sidebar-button ' + (props.page === 'orphanages' && 'active')}>
                ...
                <button type="button" onClick={() => {}} className={'sidebar-button ' + (props.page === 'pending' && 'active')}>
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
